...
# ------------------------ Weapon ------------------------ #
##switch = VRScript.Core.Audible('switch', 'Sound Effects/activate/wpn_moveselect.wav')
##hit = VRScript.Core.Audible('hit', 'Sound Effects/fast_zombie/claw_strike2.wav')
##pickup = VRScript.Core.Audible('pickup', 'Sound Effects/activate/wpn_hudoff.wav')
##
...
Weapon("Crowbar", './v_crowbar3.obj', "melee", 21)
